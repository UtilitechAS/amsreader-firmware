...
#define WIFI_AP_PASSWORD "amsreader_config"  //EHorvat new AP passord

struct SystemConfig {
	uint8_t boardType;
	bool vendorConfigured;
	bool userConfigured;
//	uint8_t dataCollectionConsent; // 0 = unknown, 1 = accepted, 2 = declined   //EHorvat disabled consent stuff
	char country[3];
}; // 7
