...
//		config.dataCollectionConsent = 0;		//EHorvat disabled consent stuff
...
void AmsConfiguration::clearUiConfig(UiConfig& config) {
	...
	config.showImport = 1;
	config.showExport = 2;
	config.showVoltage = 1;   	//EHorvat always show Voltages (was 2)
	config.showAmperage = 1;   	//EHorvat always show Amperes (was 2)
