...
//export let monthnames = ["Jan","Feb","Mar","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"];  //EHorvat translated to German
...
//    if(volt > 218 && volt < 242) return '#32d900';        //EHorvat disabled this line
//    if(volt > 212 && volt < 248) return '#b1d900';        //EHorvat disabled this line
//    if(volt > 208 && volt < 252) return '#ffb800';        //EHorvat disabled this line
    return '#297dbc';                                       //EHorvat changed to 297dbc (some kind of blue) was d90000
};

export function ampcol(pct) {
//    if(pct > 90) return '#d90000';              //EHorvat disabled this line
//    else if(pct > 85) return'#e32100';          //EHorvat disabled this line
//    else if(pct > 80) return '#ffb800';         //EHorvat disabled this line
//    else if(pct > 75) return '#dcd800';         //EHorvat disabled this line
//    else return '#d90000';                      //EHorvat disabled this line
    return '#297dbc';                             //EHorvat new... changed to 297dbc (some kind of blue) was d90000
};
