...
#include "root/minuteplot_json.h" 				//EHorvat new 5 Minute plot
...
void AmsWebServer::setup(AmsConfiguration* config, GpioConfig* gpioConfig, MeterConfig* meterConfig, AmsData* meterState, AmsDataStorage* ds, EnergyAccounting* ea) {
	...
	server.on("/minuteplot.json", HTTP_GET, std::bind(&AmsWebServer::minuteplotJson, this));	//EHorvat new 5 Minute plot
...
void AmsWebServer::dataJson() {
	...
	server.send(200, MIME_JSON, buf);
        ...
        //EHorvat new 5 Minute plot new
void AmsWebServer::minuteplotJson() {
	printD("Serving /minuteplot.json over http...");
	...
	if(ds == NULL) {
		...
		snprintf_P(buf, BufferSize, MINUTEPLOT_JSON,
			ds->get5MinuteImp(0) / 1.0,
			ds->get5MinuteImp(1) / 1.0,
			ds->get5MinuteImp(2) / 1.0,
			ds->get5MinuteImp(3) / 1.0,
			ds->get5MinuteImp(4) / 1.0,
			ds->get5MinuteImp(5) / 1.0,
			ds->get5MinuteImp(6) / 1.0,
			ds->get5MinuteImp(7) / 1.0,
			ds->get5MinuteImp(8) / 1.0,
			ds->get5MinuteImp(9) / 1.0,
			ds->get5MinuteImp(10) / 1.0,
			ds->get5MinuteImp(11) / 1.0,
			ds->get5MinuteImp(12) / 1.0,
			ds->get5MinuteImp(13) / 1.0,
			ds->get5MinuteImp(14) / 1.0,
			ds->get5MinuteImp(15) / 1.0,
			ds->get5MinuteImp(16) / 1.0,
			ds->get5MinuteImp(17) / 1.0,
			ds->get5MinuteImp(18) / 1.0,
			ds->get5MinuteImp(19) / 1.0,
			ds->get5MinuteImp(20) / 1.0,
			ds->get5MinuteImp(21) / 1.0,
			ds->get5MinuteImp(22) / 1.0,
			ds->get5MinuteImp(23) / 1.0,
			ds->get5MinuteImp(24) / 1.0,
			ds->get5MinuteImp(25) / 1.0,
			ds->get5MinuteImp(26) / 1.0,
			ds->get5MinuteImp(27) / 1.0,
			ds->get5MinuteImp(28) / 1.0,
			ds->get5MinuteImp(29) / 1.0,
			ds->get5MinuteImp(30) / 1.0,		
			ds->get5MinuteImp(31) / 1.0,
			ds->get5MinuteImp(32) / 1.0,
			ds->get5MinuteImp(33) / 1.0,
			ds->get5MinuteImp(34) / 1.0,
			ds->get5MinuteImp(35) / 1.0,
			ds->get5MinuteImp(36) / 1.0,
			ds->get5MinuteImp(37) / 1.0,
			ds->get5MinuteImp(38) / 1.0,
			ds->get5MinuteImp(39) / 1.0,
			ds->get5MinuteImp(40) / 1.0,
			ds->get5MinuteImp(41) / 1.0,
			ds->get5MinuteImp(42) / 1.0,
			ds->get5MinuteImp(43) / 1.0,
			ds->get5MinuteImp(44) / 1.0,
			ds->get5MinuteImp(45) / 1.0,
			ds->get5MinuteImp(46) / 1.0,
			ds->get5MinuteImp(47) / 1.0,
			ds->get5MinuteImp(48) / 1.0,
			ds->get5MinuteImp(49) / 1.0,
			ds->get5MinuteImp(50) / 1.0,
			ds->get5MinuteImp(51) / 1.0,
			ds->get5MinuteImp(52) / 1.0,
			ds->get5MinuteImp(53) / 1.0,
			ds->get5MinuteImp(54) / 1.0,
			ds->get5MinuteImp(55) / 1.0,
			ds->get5MinuteImp(56) / 1.0,
			ds->get5MinuteImp(57) / 1.0,
			ds->get5MinuteImp(58) / 1.0,
			ds->get5MinuteImp(59) / 1.0,
			ds->get5MinuteExp(0) / 1.0,
			ds->get5MinuteExp(1) / 1.0,
			ds->get5MinuteExp(2) / 1.0,
			ds->get5MinuteExp(3) / 1.0,
			ds->get5MinuteExp(4) / 1.0,
			ds->get5MinuteExp(5) / 1.0,
			ds->get5MinuteExp(6) / 1.0,
			ds->get5MinuteExp(7) / 1.0,
			ds->get5MinuteExp(8) / 1.0,
			ds->get5MinuteExp(9) / 1.0,
			ds->get5MinuteExp(10) / 1.0,
			ds->get5MinuteExp(11) / 1.0,
			ds->get5MinuteExp(12) / 1.0,
			ds->get5MinuteExp(13) / 1.0,
			ds->get5MinuteExp(14) / 1.0,
			ds->get5MinuteExp(15) / 1.0,
			ds->get5MinuteExp(16) / 1.0,
			ds->get5MinuteExp(17) / 1.0,
			ds->get5MinuteExp(18) / 1.0,
			ds->get5MinuteExp(19) / 1.0,
			ds->get5MinuteExp(20) / 1.0,
			ds->get5MinuteExp(21) / 1.0,
			ds->get5MinuteExp(22) / 1.0,
			ds->get5MinuteExp(23) / 1.0,
			ds->get5MinuteExp(24) / 1.0,
			ds->get5MinuteExp(25) / 1.0,
			ds->get5MinuteExp(26) / 1.0,
			ds->get5MinuteExp(27) / 1.0,
			ds->get5MinuteExp(28) / 1.0,
			ds->get5MinuteExp(29) / 1.0,
			ds->get5MinuteExp(30) / 1.0,		
			ds->get5MinuteExp(31) / 1.0,
			ds->get5MinuteExp(32) / 1.0,
			ds->get5MinuteExp(33) / 1.0,
			ds->get5MinuteExp(34) / 1.0,
			ds->get5MinuteExp(35) / 1.0,
			ds->get5MinuteExp(36) / 1.0,
			ds->get5MinuteExp(37) / 1.0,
			ds->get5MinuteExp(38) / 1.0,
			ds->get5MinuteExp(39) / 1.0,
			ds->get5MinuteExp(40) / 1.0,
			ds->get5MinuteExp(41) / 1.0,
			ds->get5MinuteExp(42) / 1.0,
			ds->get5MinuteExp(43) / 1.0,
			ds->get5MinuteExp(44) / 1.0,
			ds->get5MinuteExp(45) / 1.0,
			ds->get5MinuteExp(46) / 1.0,
			ds->get5MinuteExp(47) / 1.0,
			ds->get5MinuteExp(48) / 1.0,
			ds->get5MinuteExp(49) / 1.0,
			ds->get5MinuteExp(50) / 1.0,
			ds->get5MinuteExp(51) / 1.0,
			ds->get5MinuteExp(52) / 1.0,
			ds->get5MinuteExp(53) / 1.0,
			ds->get5MinuteExp(54) / 1.0,
			ds->get5MinuteExp(55) / 1.0,
			ds->get5MinuteExp(56) / 1.0,
			ds->get5MinuteExp(57) / 1.0,
			ds->get5MinuteExp(58) / 1.0,
			ds->get5MinuteExp(59) / 1.0
		);
