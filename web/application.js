...
var sa;
var so = {
    title: 'letzte 5 Minuten',  // ****** EHorvat was Energy use last 5 Minutes
    titleTextStyle: {
        fontSize: 14
    },
...
var drawMinute = function() {
    $.ajax({
        ...
        //   EHorvat .... next 2 Lines....option to exchange "Export" with "Import" (to show Import as "negativ" values on plot)
        data = [['Hour', 'Bezug', { role: 'style' }, 'Export', { role: 'style' }]]; //  EHorvat ... original: Import is positive
        //data = [['Hour', 'Export', { role: 'style' }, { role: 'annotation' }, 'Import', { role: 'style' }, { role: 'annotation' }]];  //EHorvat exchanged Import / Export
        var r = 1;
        var min = 0;
        for(var i = 59; i > -1; i--) {   // Show current data on right side
            ...
            data[r++] = ["vor " + ((i+1)*5) + " Sek.", imp, "opacity: 0.9;",  exp == 0 ? 0 : -exp, "opacity: 0.9;"]; //  EHorvat ... original: Import is positive
        ...
        setTimeout(drawMinute, interval);  //Timeout to 5 Sec
    });
};
